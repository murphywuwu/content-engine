...
Replace this starter profile before the first serious draft.
...
| `lanes.md` | Publishing lanes |
| `keywords.md` | Three-track: listen→Hits, search=SEO, ask=GEO |
| `handles.md` | ≤8 ally/foil/competitor handles |

Accounts: see `accounts/_index.md`.
